...
var baseEndpoint = 'https://recipes.beginnerjavascript.com/api';
var proxy = "https://corsproxy.io/?";
var form = document.querySelector('form.search');
var recipesGrid = document.querySelector('.recipes');
function fetchRecipes(_x) {
  return _fetchRecipes.apply(this, arguments);
}
function _fetchRecipes() {
  _fetchRecipes = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(query) {
    var res, data;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return fetch("".concat(proxy).concat(baseEndpoint, "?q=").concat(query));
        case 2:
          res = _context.sent;
          _context.next = 5;
          return res.json();
...
function fetchAndDisplay(_x3) {
  return _fetchAndDisplay.apply(this, arguments);
}
function _fetchAndDisplay() {
  _fetchAndDisplay = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(query) {
    var recipes;
...
function displayRecipes(recipes) {
  ...
  var html = recipes.map(function (recipe) {
    return "\n    <div class=\"recipe\">\n      <h2>".concat(recipe.title, "</h2>\n      <p>").concat(recipe.ingredients, "</p>\n      ").concat(recipe.thumbnail && "<img class=\"recipe-image\" width=\"100px\" src=\"".concat(recipe.thumbnail, "\" alt=\"").concat(recipe.title, "\"/>"), "\n      <a href=\"{$recipe.href}\">View Recipe &#10140;</a>\n    </div>");
  });
